...
// let heart=card.querySelector(".heart").innerHTML
// let img=card.querySelector("img").src
// let h2 =card.querySelector(".cardTitle").innerHTML
// let p=card.querySelector(".cardText").innerHTML
// let span=card.querySelector(".cardPrice").innerHTML
// let cartContent={
//     heart,
//     img,
//     h2,
...
// cardContent.style.alingItems="center"
// cardContent.style.gap="10px"
// cardContent.style.marginTop="20px"
// cardContent.style.color="burlwood"
...
// let h2=document.querySelector(".cardTitle")
// h2.textContent="Card haqqinda"
// let p=document.querySelector(".cardText")
// p.textContent="yeni"
// let span=document.querySelector(".cardPrice")
// span.textContent="500AZN"
// let button=document.querySelector(".shopBtn")
// button.textContent="indi al"